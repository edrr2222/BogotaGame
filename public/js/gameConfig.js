...
// Sonidos de ambiente hechos por un compañero de equipo para 5
// localidades (grabados con variante día/noche) — se guardan tal cual en
// assets/<Localidad>/sonidos/. Street View real es siempre de día (son
// fotos reales, Google no tiene versión nocturna), así que acá solo se
// usa la variante "day". Las localidades que no están en este mapa caen
// al genérico assets/sound/<Localidad>/ambiente.mp3 en su lugar (ver
// StreetViewScene.playAmbientSound).
export const AMBIENT_OVERRIDE = {
  "Chapinero": 'Chapinero/sonidos/chapinero_dia.mp4',
  "Kennedy": 'Kennedy/sonidos/kennedy_dia.mp4',
  "Suba": 'Suba/sonidos/suba_dia.mp4',
  "Puente Aranda": 'Puente_Aranda/sonidos/puente_aranda_dia.mp4',
  "Usme": 'Usme/sonidos/usme_dia.ogg',
};
